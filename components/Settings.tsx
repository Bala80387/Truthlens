...
export const Settings: React.FC = () => {
  ...
  const handleGoogleConnect = async () => {
    ...
    try {
      ...
      // 2. Construct OAuth URL client-side
      const origin = window.location.origin;
      const redirectUri = `${origin}/auth/callback`;
      
      // Encode state with redirectUri to ensure consistency
             ...
             <div className="flex items-center justify-between">
                ...
                {user ? (
                  ...
                  <div className="flex flex-col items-end space-y-2">
                    ...
                    <div className="text-[10px] text-slate-500 text-right max-w-[250px]">
                        <p>Callback URL (Add to Google Console):</p>
                        <code className="bg-black/30 px-1 py-0.5 rounded select-all cursor-text block mt-1 break-all">
